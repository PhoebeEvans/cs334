...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function populateTableFromServer(apiEndpoint, targetTableBodySelector) {
        ...
        try {
            ...
            data.forEach(item => {
                insertDataIntoTable(item, targetTableBody);
            });
        } catch (error) {
    ...
    function initializeAdminPage() {
        // Call populateTableFromServer() to populate the products table
        populateTableFromServer('/products', '#active-products-table > tbody');
        ...
        if (adminIndexElement) {
            // Call populateTableFromServer() to populate the transactions table
            populateTableFromServer('/transactions', '#transactions-table > tbody');
        }
    }
